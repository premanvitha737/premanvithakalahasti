...
class TodoListApp(tk.Tk):
    def __init__(self):
        ...
        self.task_input.insert(0, "Make your todo list here...")
    ...
    def add_task(self):
        ...
        if task != "Make your todo list here...":
            self.task_list.insert(tk.END, task)
            self.task_list.itemconfig(tk.END, fg="purple")
    ...
    def clear_placeholder(self, event):
        if self.task_input.get() == "Make your todo list here...":
            self.task_input.delete(0, tk.END)
